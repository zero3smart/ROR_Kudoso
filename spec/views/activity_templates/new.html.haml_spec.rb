...
RSpec.describe "activity_templates/new", :type => :view do
  before(:each) do
    assign(:activity_template, ActivityTemplate.new(
      :name => "MyString",
  ...
  it "renders new activity_template form" do
    render

    assert_select "form[action=?][method=?]", activity_templates_path, "post" do
